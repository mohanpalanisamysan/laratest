	...
	<div class="container">
		...
		<div class="row g-4">
			...
			<div class="col-lg-3">
				<!-- logo -->
				<a href="index.html">
					<img class="h-40px" src=" {{ url('/public/assets/images/logo-light.svg') }}" alt="logo">
				</a>
				<p class="my-3 text-muted">Departure defective arranging rapturous did believe him all had supported.</p>
				<p class="mb-2"><a href="#" class="text-muted text-primary-hover"><i class="bi bi-telephone me-2"></i>+91-</a> </p>
		...
		<div class="row g-4 justify-content-between mt-0 mt-md-2">
			...
			<div class="col-sm-7 col-md-6 col-lg-4">
				...
				<ul class="list-inline mb-0 mt-3">
					<li class="list-inline-item"> <a href="#"><img src=" {{ url('/public/assets/images/element/paypal.svg') }}" class="h-30px" alt=""></a></li>
					<li class="list-inline-item"> <a href="#"><img src=" {{ url('/public/assets/images/element/visa.svg') }}" class="h-30px" alt=""></a></li>
					<li class="list-inline-item"> <a href="#"><img src=" {{ url('/public/assets/images/element/mastercard.svg') }}" class="h-30px" alt=""></a></li>
					<li class="list-inline-item"> <a href="#"><img src=" {{ url('/public/assets/images/element/expresscard.svg') }}" class="h-30px" alt=""></a></li>
				</ul>
			</div>

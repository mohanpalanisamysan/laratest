					...
					<div class="card card-body shadow border p-4">
						<div class="d-flex justify-content-between align-items-center mb-3">
							...
							<div class="me-2">
								...
								<h3 class="mb-0 mt-2">{{ $getRecordNewusersAnonymous->total() }}</h3>
							</div>
							<!-- Icon -->
			...
			<div class="col-12">
				...
				<div class="table-responsive-xl">
					...
					<table class="table table-compare align-middle">
						...
						@foreach($getRecordNewusersAnonymous as $value)
						<!-- Body START -->
					...
					<div class="">
						{!! $getRecordNewusersAnonymous->appends(Illuminate\Support\Facades\Request::except('page'))->links() !!}
					</div>

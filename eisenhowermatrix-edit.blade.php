@extends('student.home.layouts.app')
...
<section class="py-0 mb-4">
	<div class="container position-relative">
		<div class="bg-primary bg-opacity-10 rounded-3 position-relative p-4 p-sm-4">
			<!-- Svg decoration -->
			...
			<div class="row align-items-center position-relative">
				<div class="col-lg-8">
					...
					<div class="d-flex">
						...
						<img src="{{ url('public/assets/images/element/task.png') }}" class="h-40px ms-3" alt="">
					</div>
					<p class="mb-3 mb-lg-0 small">Prioritize Tasks by Urgency & Importance</p>
				</div>
				<!-- Content and input -->
				<div class="col-lg-4 text-lg-end">
					<a href="{{ url('/student/home/dev/eisenhowermatrix/eisenhowermatrix-list') }}" class="btn btn-sm btn-primary mb-0"><i class="bi bi-box-arrow-in-left me-2"></i>Back</a>
				</div>
			</div> <!-- Row END -->
		</div>
	</div>
...
<section class="pb-0 py-0 mb-4">
	<div class="container">
		<div class="row">
			...
			<h5 class="mb-2 accent">Update Task</h5>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-10 mx-auto">
				...
				{{ csrf_field() }}
					<!-- Task Basic  Detail START -->
					<div class="card shadow p-xl-3">
						<!-- Card header -->
						<div class="card-header border-bottom">
							<h6 class="mb-0">Task Basic Detail</h6>
						</div>
						...
						<div class="card-body">
							<div class="row g-3">
								...
								<div class="col-md-12">
									...
									<input class="form-control" name="task_name" value="{{ $getRecordEisenhowermatrix->task_name }}" type="text" placeholder="Enter Task Name">
								</div>

								<!-- Task Importance -->
								<div class="col-md-6">
									<label class="form-label">Task Importance</label>
									<select class="form-select js-choice" name="task_importance" data-search-enabled="true">
										<option value="">Select Task Importance</option>
										<option {{ ($getRecordEisenhowermatrix->task_importance == "Important") ? 'selected' : '' }} value="Important">Important</option>
										<option {{ ($getRecordEisenhowermatrix->task_importance == "Not Important") ? 'selected' : '' }} value="Not Important">Not Important</option>
									</select>
								</div>

								<!-- Task Urgency -->
								<div class="col-md-6">
									<label class="form-label">Task Urgency</label>
									<select class="form-select js-choice" name="task_urgency" data-search-enabled="true">
										<option value="">Select Task Urgency</option>
										<option {{ ($getRecordEisenhowermatrix->task_urgency == "Urgent") ? 'selected' : '' }} value="Urgent">Urgent</option>
										<option {{ ($getRecordEisenhowermatrix->task_urgency == "Not Urgent") ? 'selected' : '' }} value="Not Urgent">Not Urgent</option>
									</select>
								</div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="planned_start" class="form-control flatpickr" value="{{ $getRecordEisenhowermatrix->planned_start }}" data-date-format="Y-m-d" placeholder="Enter Event Start Date">
                            </div> 

                            <!-- Event Start Date -->
                            <div class="col-md-6">
                                <label class="form-label">Planned End Date</label>
                                <input type="date" name="planned_end" class="form-control flatpickr" value="{{ $getRecordEisenhowermatrix->planned_end }}" data-date-format="Y-m-d" placeholder="Enter Event Start Date">
                            </div> 
					...
					<!-- Task Basic Detail END -->

                    <!-- Button -->
                    <div class="col-12 text-end">
                        <button type="submit" class="btn btn-danger btn-sm mb-0"><i class="bi bi-box-arrow-in-up-right me-2"></i>Update Task</button>
                        <a href="{{ url('/student/home/dev/eisenhowermatrix/eisenhowermatrix-list') }}" class="btn btn-secondary btn-sm mb-0"><i class="bi bi-x-circle me-2"></i>Cancel</a>
                    </div>
				</form>
			</div>
		</div>
